...
//top, AppUtil.dpToPx(getContext(), rectWidth) + left, AppUtil.dpToPx(getContext(), rectHeight) + top, left
        RectF rect = new RectF( left * 4, 0, left * 10 , top + AppUtil.dpToPx(getContext(), 600));
